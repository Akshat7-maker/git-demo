    ...
    >
      ...
      <AccordionDetails>
        ...
        {/* <ContentInput 
                ...
                /> */}
        <TiptapEditor
          value={watch("browseArtist.title")}
          onChange={(value: string) =>
            setValue("browseArtist.title", value, { shouldValidate: true })
          }
          height={200}
        />
        {/* <ContentInput 
                ...
                /> */}
        <TiptapEditor
          value={watch("browseArtist.description")}
          onChange={(value: string) =>
            setValue("browseArtist.description", value, { shouldValidate: true })
          }
          height={200}
        />
      </AccordionDetails>
