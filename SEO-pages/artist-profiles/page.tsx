...
import ArtistProfilePreview from "./components/Preview";
...
export default function LandingPageTextManager({
  ...
  const { mutate: addArtistProfile, loading: isLoadingAddSEO } = useMutation(
    `add-artist-profile`,
    {
      method: "POST",
    }
    ...
    <>
          ...
          <Box className="d-flex justify-content-between align-items-center mb-4">
            ...
            <Box display="flex" gap={2}>
              ...
              <Button
                ...
                type="submit"
                // onClick={handleFormSubmit}
                disabled={isLoading || isLoadingAddSEO}
                startIcon={
                  isLoading ? (
      ...
      >
        ...
        >
          ...
          <ArtistProfilePreview pageData={methods.getValues()} />
        </Box>
      </Dialog>
    </>
  );
