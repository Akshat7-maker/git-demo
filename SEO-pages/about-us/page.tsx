...
import { ChevronDown, Save, FileText, AlertCircle, Globe, Eye, X } from "lucide-react";
...
import BrandsWeLove from "./components/second-para";

import SecondPara from "./components/second-para";
...
const heroSchema = z.object({
  title: z
    ...
    .max(85, "Title too long"),
  // subTitle: z.string().min(1, "Sub-title is required").max(97, "Sub-title is required"),
  description: z
    .string()
    .min(1, "Description is required")
    .max(233, "Description too long"),
  // image: z.string().min(1, "Image is required"),
});

// 2. Book Artist Section Schema
const secondParaSchema = z.object({
  title: z.string().min(1, "Section title is required").max(83, "Title too long"),
  //   subText: z.string().min(1, "Sub-text is required"), // copied from artist hub
  description: z.string().min(1, "Description is required").max(234, "Description is required"),
});


// const freelanceSchema = z.object({
//   title: z.string().min(1, "Section title is required").max(44, "Title too long"),
//   //   subText: z.string().min(1, "Sub-text is required"), // copied from artist hub
//   description: z.string().min(1, "Description is required").max(400, "Description is required"),
// });
...
export const landingPageSchema = z.object({
  makeup_hub: heroSchema,
  beauty_hub: secondParaSchema,
