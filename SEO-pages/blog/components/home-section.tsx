...
import CKEditorClient from '@/app/(DashboardLayout)/cms/_components/Editor';
        ...
        >
            <AccordionSummary expandIcon={<ChevronDown />}>
                ...
                >
                    ...
                    Introduction {hasSectionError && "(Errors Found)"}
                </Typography>
            </AccordionSummary>
            <AccordionDetails>
                
                {/* <ContentInput 
                    section="blog_hub" field="title" label="Main Heading" max={22} 
                    register={register} watch={watch} errors={errors} 
                /> */}
                {/* <CKEditorClient
                value={watch('blog_hub.title')}
                 onChange={(value: any) => {
                    setValue('blog_hub.title', value);
                 }}
                 ></CKEditorClient> */}
                 <TiptapEditor
                    value={watch('blog_hub.title')}
                ...
                {/* <ContentInput 
                    section="blog_hub" field="description" label="Intro Paragraph" multiline rows={3} max={142} 
                    register={register} watch={watch} errors={errors} 
                /> */}
                <TiptapEditor
                    value={watch('blog_hub.description')}
                    onChange={(value: any) => {
                        setValue('blog_hub.description', value);
                    }}
                />
