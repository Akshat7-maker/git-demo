...
import { ChevronDown, Save, FileText, AlertCircle, Globe, X, Eye } from "lucide-react";
...
const seoSchema = z.object({
  title: z
    ...
    .max(100, "Title should be under 60 characters"), // Optimal for SEO
  description: z
    .string()
    .min(1, "SEO description is required")
    .max(142, "Keep under 160 chars for Google"),
  meta_tags: z
    .array(
      z.object({
