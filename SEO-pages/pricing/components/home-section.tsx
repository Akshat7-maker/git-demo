    ...
    return (
        ...
        >
            ...
            <AccordionDetails>
                ...
                {/* <ContentInput 
                    section="artist" field="mainTitle" label="Main Heading" max={42} 
                ...
                {/* <ContentInput 
                    section="artist" field="subTitle" label="Sub-Heading Line" max={55} 
                    register={register} watch={watch} errors={errors} 
                /> */}
                <TiptapEditor
                ...
                {/* <ContentInput 
                    section="artist" field="description" label="Intro Paragraph" multiline rows={3} max={375} 
                    register={register} watch={watch} errors={errors} 
                /> */}
                <TiptapEditor
