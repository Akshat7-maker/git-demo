    ...
    >
      <AccordionSummary expandIcon={<ChevronDown />}>
        ...
        >
          ...
          Freelance Section {hasSectionError && "(Errors Found)"}
        </Typography>
      </AccordionSummary>
      <AccordionDetails>
        {/* 2. PASS PROPS EXPLICITLY */}
        {/* <ContentInput 
                    section="freelanceArtist" 
                    field="title" 
                    label="Section Title" 
                    max={70}
                    register={register}
                ...
                /> */}
        <TiptapEditor
          value={watch("freelanceArtist.title")}
          onChange={(value: string) => setValue("freelanceArtist.title", value)}
          height={200}
        />
        {/* <ContentInput
          section="freelanceArtist"
        ...
        /> */}
        <TiptapEditor
          value={watch("freelanceArtist.description")}
          onChange={(value: string) =>
            setValue("freelanceArtist.description", value)
          }
          height={200}
        />
      </AccordionDetails>
