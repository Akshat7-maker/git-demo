        ...
        >
            <AccordionSummary expandIcon={<ChevronDown />}>
                ...
                >
                    ...
                    Job Board Description {hasSectionError && "(Errors Found)"}
                </Typography>
            </AccordionSummary>
            <AccordionDetails>
                ...
                /> */}
                <TiptapEditor 
                value={watch("job_board.title")} 
                onChange={(val: any) => setValue("job_board.title", val)}
                height={200}
                />
                {/* <ContentInput 
                    section="job_board" 
                ...
                /> */}
                <TiptapEditor 
                value={watch("job_board.description")} 
                onChange={(val: any) => setValue("job_board.description", val)}
                height={200}
                />
            </AccordionDetails>
        </Accordion>
