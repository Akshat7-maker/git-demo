    ...
    return (
        ...
        >
            ...
            <AccordionDetails>
                ...
                {/* <ContentInput 
                    section="makeup_artist" field="mainTitle" label="Main Heading" max={44} 
                    register={register} watch={watch} errors={errors} 
                /> */}
                <TiptapEditor
                value={watch('makeup_artist.mainTitle')}
                onChange={(value: string) => setValue('makeup_artist.mainTitle', value)}
                height={200}
                />

                
                {/* <ContentInput 
                    section="makeup_artist" field="subTitle" label="Sub-Heading Line" max={55} 
                    register={register} watch={watch} errors={errors} 
                /> */}
                <TiptapEditor
                value={watch('makeup_artist.subTitle')}
                onChange={(value: string) => setValue('makeup_artist.subTitle', value)}
                height={200}
                />
                
                {/* <ContentInput 
                    section="makeup_artist" field="description" label="Intro Paragraph" multiline rows={3} max={375} 
                    register={register} watch={watch} errors={errors} 
                /> */}
                <TiptapEditor
                value={watch('makeup_artist.description')}
                onChange={(value: string) => setValue('makeup_artist.description', value)}
                height={200}
                />
