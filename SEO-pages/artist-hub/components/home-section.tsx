    ...
    return (
        ...
        >
            ...
            <AccordionDetails>
                ...
                {/* <ContentInput 
                    section="artist_hub" field="title" label="Main Heading" max={44} 
                    register={register} watch={watch} errors={errors} 
                /> */}
                <TiptapEditor 
                value={watch("artist_hub.title")}
                onChange={(value: string) => setValue("artist_hub.title", value)}
                height={200}
                />
                
                {/* <ContentInput 
                    section="artist_hub" field="description" label="Sub-Heading Line" max={165} 
                    register={register} watch={watch} errors={errors} 
                /> */}
                <TiptapEditor 
                value={watch("artist_hub.description")}
                onChange={(value: string) => setValue("artist_hub.description", value)}
                height={200}
                />
                
                {/* <ContentInput 
                    section="hero" field="description" label="Intro Paragraph" multiline rows={3} max={325} 
                    register={register} watch={watch} errors={errors} 
                /> */}
