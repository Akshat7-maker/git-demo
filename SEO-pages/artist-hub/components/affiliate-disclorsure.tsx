...
export default function Affililate() {
    const { 
        register, 
        watch,
        formState: { errors } ,
        ...
        >
            <AccordionSummary expandIcon={<ChevronDown />}>
                ...
                >
                    ...
                    Affiliate Disclosure {hasSectionError && "(Errors Found)"}
                </Typography>
            </AccordionSummary>
            <AccordionDetails>
                ...
                /> */}
                <TiptapEditor
                value={watch("affiliate.title")}
                onChange={(value: string) => setValue("affiliate.title", value, { shouldValidate: true })}
                height={100}
                />
                {/* <ContentInput 
                    section="affiliate" 
                ...
                /> */}
                <TiptapEditor
                value={watch("affiliate.description")}
                onChange={(value: string) => setValue("affiliate.description", value, { shouldValidate: true })}
                height={100}
                />
            </AccordionDetails>
        </Accordion>
